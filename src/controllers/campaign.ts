...
export default class CampaignController {
  ...
  public getCampaigns = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const responseData: ResponseObject = {
      ...
      message: CampaignMessages.CAMPAIGNS,
      data,
    };
  ...
  public getCampaignDetails = catchAsync(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const responseData: ResponseObject = {
        statusCode: StatusCodes.OK,
        message: CampaignMessages.CAMPAIGN_DETAILS,
        data,
      };
      return sendResponse(res, responseData);
    }
  ...
  public getCampaignMetrics = catchAsync(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const responseData: ResponseObject = {
        statusCode: StatusCodes.OK,
        message: CampaignMessages.CAMPAIGN_METRICS,
        data,
      };
